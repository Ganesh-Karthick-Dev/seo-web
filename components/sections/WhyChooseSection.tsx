...
const features = [
    {
        ...
        position: "top-[20%] left-[2%] lg:left-[2%]" // 9:30 Position
    },
    {
        icon: Cpu,
        ...
        position: "top-[5%] left-1/2 -translate-x-1/2 w-full max-w-[300px]" // 12:00 Position
    },
    {
        icon: Shuffle,
        ...
        position: "top-[28%] right-[2%] lg:right-[2%]" // 3:00 Position
    },
    {
        icon: Rocket,
        ...
        position: "bottom-[10%] right-[3%] lg:right-[8%]" // 4:30 Position
    },
    {
        icon: ShieldCheck,
        title: "Future Proof",
        ...
        position: "bottom-[10%] left-[3%] lg:left-[8%]" // 7:00 Position
    },
];
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full h-full max-w-7xl mx-auto pointer-events-none">
                {/* Center Big Title - Absolutely Positioned */}
                ...
                {/* Scattered Cards - Absolutely Positioned */}
                {features.map((feature, i) => (
                    ...
                    >
                        <h3 className="text-black text-sm md:text-base font-bold uppercase tracking-wide mb-3">
                            {feature.title}
                        </h3>

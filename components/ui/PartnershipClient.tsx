...
const estimatorPhases = [
    {
        ...
        multiSelect: true,
        options: [
            { id: "frd", label: "FRD (Functional Requirements)", ourCost: 300, competitorCost: 1800, days: 0.5 },
            { id: "brd", label: "BRD (Business Requirements)", ourCost: 300, competitorCost: 1500, days: 0.5 },
            { id: "prd", label: "PRD (Product Requirements)", ourCost: 400, competitorCost: 1800, days: 0.5 },
            { id: "techSpec", label: "Technical Specification", ourCost: 500, competitorCost: 2400, days: 1 },
            { id: "wireframes", label: "Wireframes / Mockups", ourCost: 700, competitorCost: 3100, days: 1 },
        ],
    },
    {
        id: "appType",
        ...
        multiSelect: false,
        options: [
            { id: "b2b_saas", label: "B2B SaaS Platform", ourCost: 1500, competitorCost: 5200, days: 3 },
            { id: "b2c_saas", label: "B2C SaaS Platform", ourCost: 1200, competitorCost: 4200, days: 2 },
            { id: "mobile_app", label: "Mobile Application", ourCost: 2000, competitorCost: 8500, days: 4 },
            { id: "ecommerce", label: "E-Commerce Platform", ourCost: 1800, competitorCost: 6200, days: 3 },
            { id: "internal_tool", label: "Internal Tool / Dashboard", ourCost: 1000, competitorCost: 3300, days: 2 },
            { id: "ai_agent", label: "AI Agent / Automation", ourCost: 2500, competitorCost: 9800, days: 5 },
        ],
    },
    {
        id: "architecture",
        ...
        multiSelect: false,
        options: [
            { id: "serverless", label: "Serverless Architecture", ourCost: 800, competitorCost: 5200, days: 1.5 },
            { id: "microservices", label: "Microservices Architecture", ourCost: 1200, competitorCost: 7800, days: 2 },
            { id: "monolithic", label: "Monolithic Architecture", ourCost: 500, competitorCost: 2800, days: 1 },
            { id: "api_first", label: "API-First Architecture", ourCost: 700, competitorCost: 4100, days: 1 },
        ],
    },
    {
        id: "database",
        ...
        multiSelect: false,
        options: [
            { id: "postgres", label: "PostgreSQL Setup & Schema", ourCost: 400, competitorCost: 2000, days: 1 },
            { id: "mongodb", label: "MongoDB Setup & Schema", ourCost: 350, competitorCost: 1600, days: 1 },
            { id: "redis", label: "Redis Cache Layer", ourCost: 300, competitorCost: 1100, days: 0.5 },
            { id: "multi_db", label: "Multi-DB Architecture", ourCost: 600, competitorCost: 3200, days: 1.5 },
            { id: "data_modelling", label: "Data Modelling Consultation", ourCost: 300, competitorCost: 1000, days: 0.5 },
        ],
    },
    {
        id: "auth",
        ...
        multiSelect: false,
        options: [
            { id: "oauth_mfa", label: "OAuth + MFA", ourCost: 600, competitorCost: 2800, days: 1 },
            { id: "sso", label: "SSO Integration", ourCost: 500, competitorCost: 3100, days: 1 },
            { id: "jwt", label: "JWT + Refresh Tokens", ourCost: 300, competitorCost: 1100, days: 0.5 },
            { id: "rbac", label: "Role-Based Access Control", ourCost: 400, competitorCost: 1700, days: 1 },
        ],
    },
    {
        id: "features",
        ...
        maxSelections: 6,
        options: [
            { id: "business_logic", label: "Business Logic & APIs", ourCost: 2500, competitorCost: 7400, days: 4 },
            { id: "user_dash", label: "User Dashboard", ourCost: 1500, competitorCost: 4600, days: 3 },
            { id: "admin_panel", label: "Admin Panel", ourCost: 800, competitorCost: 2300, days: 1.5 },
            { id: "notification", label: "Notification System", ourCost: 500, competitorCost: 1400, days: 1 },
            { id: "onboarding", label: "User Onboarding Flow", ourCost: 700, competitorCost: 1900, days: 1 },
        ],
    },
    {
        id: "design",
        ...
        multiSelect: false,
        options: [
            { id: "premium_ui", label: "Premium Custom UI", ourCost: 1800, competitorCost: 7800, days: 3 },
            { id: "design_system", label: "Design System / Component Library", ourCost: 1200, competitorCost: 4200, days: 2 },
            { id: "responsive", label: "Mobile-First Responsive", ourCost: 600, competitorCost: 2000, days: 1 },
        ],
    },
    {
        id: "testing",
        ...
        multiSelect: true,
        options: [
            { id: "unit_testing", label: "Automated Unit Testing", ourCost: 400, competitorCost: 2200, days: 1 },
            { id: "e2e_testing", label: "End-to-End Testing", ourCost: 500, competitorCost: 2000, days: 1 },
            { id: "load_testing", label: "Performance & Load Testing", ourCost: 350, competitorCost: 1400, days: 0.5 },
            { id: "security_audit", label: "Security Audit", ourCost: 600, competitorCost: 2100, days: 1 },
        ],
    },
    {
        id: "payments",
        ...
        multiSelect: false,
        options: [
            { id: "stripe_sub", label: "Stripe Subscriptions", ourCost: 700, competitorCost: 3200, days: 1.5 },
            { id: "stripe_one", label: "Stripe One-Time Payments", ourCost: 400, competitorCost: 1500, days: 1 },
            { id: "multi_currency", label: "Multi-Currency Support", ourCost: 400, competitorCost: 1800, days: 1 },
            { id: "invoice", label: "Invoice Generation", ourCost: 300, competitorCost: 1000, days: 0.5 },
        ],
    },
    {
        id: "deployment",
        ...
        multiSelect: true,
        options: [
            { id: "cicd", label: "CI/CD Pipeline", ourCost: 500, competitorCost: 3100, days: 1 },
            { id: "aws_infra", label: "AWS Infrastructure Setup", ourCost: 400, competitorCost: 2200, days: 1 },
            { id: "docker", label: "Docker + Containerisation", ourCost: 300, competitorCost: 1400, days: 0.5 },
            { id: "monitoring", label: "Monitoring + Alerting", ourCost: 200, competitorCost: 900, days: 0.5 },
        ],
    },
];

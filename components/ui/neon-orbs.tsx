...
export function NeonOrbs({
    ...
    return (
        <>
            ...
            <div className="hidden lg:flex relative w-full h-screen overflow-hidden items-center justify-center bg-slate-100 dark:bg-[#050a18] transition-colors duration-500">
                ...
                <style jsx global>{`
                    ...
                    .orb-light {
                        ...
                        box-shadow: 0 0 60px 2px rgba(99, 102, 241, 0.3), 0 0 100px 5px rgba(99, 102, 241, 0.15), inset 0 0 60px 2px rgba(99, 102, 241, 0.08);
                        border: 1px solid rgba(99, 102, 241, 0.4);
                    }
                    
                    .dark .orb-light {
                        background: radial-gradient(circle at 50% 50%, #050a18 0%, #050a18 90%, transparent 100%);
                        box-shadow: 0 0 60px 2px rgba(59, 130, 246, 0.4), 0 0 100px 5px rgba(59, 130, 246, 0.2), inset 0 0 60px 2px rgba(59, 130, 246, 0.1);
            ...
            {/* MOBILE/TABLET VERSION (below lg) - Using Lamp Effect */}
            <div className="lg:hidden">
                <LampContainer className="bg-slate-100 dark:bg-slate-950">
                    <motion.div

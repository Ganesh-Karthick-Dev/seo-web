  ...
  return (
    <div className="relative w-full bg-black/[0.96] antialiased">
      ...
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-grid-white/[0.02]">
        ...
        <div className="relative z-10 flex w-full max-w-[90rem] flex-col items-center justify-center px-4 pt-32">
          <div className="flex flex-col items-center gap-6 text-center max-w-7xl">

            {/* Headline - Increased width and adjusted sizing */}

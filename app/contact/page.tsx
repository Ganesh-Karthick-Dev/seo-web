...
export default function Contact() {
    ...
    return (
        <div ref={containerRef} className="relative min-h-screen w-full bg-black/[0.96] antialiased">
            {/* Background Effects */}
            ...
            <div className="relative z-10">
                ...
                <div className="sticky top-0 h-[40vh] md:h-[50vh] flex items-center justify-center px-4 overflow-hidden pointer-events-none">
                    <motion.div
                        style={{
                            y: headerY,

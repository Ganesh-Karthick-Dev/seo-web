...
export default async function ITConsultingPage() {
  ...
  "itemListElement": [{
    ...
    "position": 2, 
    "name": "IT Consulting",
    "item": "https://zylex.io/services/it-strategy-consulting"  
  }]
}`
                }}
            />
  ...
  "description": "Zylex provides IT strategy consulting services that help organizations align technology initiatives with business goals, optimize IT investments, and develop roadmap strategies for digital growth, scalable systems, and technical excellence.",
  "provider": {
    "@type": "Organization",
    "name": "Zylex",
    "url": "https://zylex.io/"
  ...
  "audience": {
    ...
    "audienceType": "Startups, SMEs, Enterprises, CTOs, IT Leaders, Product Teams"
  },
  "url": "https://zylex.io/services/it-strategy-consulting",
  "offers": {
    "@type": "Offer",
